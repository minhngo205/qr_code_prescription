              ...
              children: [
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      buildDateColumn("T.2", 7, false),
                      buildDateColumn("T.3", 8, false),
                      buildDateColumn("T.4", 9, false),
                      buildDateColumn("T.5", 10, true),
                      buildDateColumn("T.6", 11, false),
                      buildDateColumn("T.7", 12, false),
                      buildDateColumn("CN", 13, false),
                    ],
                  ),
                ),
                Expanded(
